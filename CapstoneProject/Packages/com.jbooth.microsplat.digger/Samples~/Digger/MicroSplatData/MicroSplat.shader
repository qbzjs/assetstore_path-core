...
void PrepareStochasticUVs(float scale, float2 uv, out float2 uv1, out float2 uv2, out float2 uv3, out half3 weights)
{
   ...
   weights = half3(w1, w2, w3);
      ...
      void DiggerEncodeVertex(appdata i, inout Input IN)
      {
         IN.w0 = DecodeToFloat4(i.color.r);
            ...
            IN.fx = DecodeToFloat4(i.texcoord2.w);
         #endif
      }
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/MicroSplat_Base1320358580"
   Fallback "Hidden/MicroSplat/MicroSplat_Base1320358580"
