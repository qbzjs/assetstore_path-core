    ...
    public class BeastEditorWindow : EditorWindow
    {
        ...
        void DrawSaveOptions()
        {
            ...
            using (new EditorGUIHelper.EditorGUILayoutBeginVertical(EditorStyles.helpBox))
            {
                ...
                {
                    using (new EditorGUIHelper.GUIBackgroundColor(EditorUtilities.ContainsInvalidFileNameCharacters(meshFilePrefix) ? Color.red : Color.white))
                    {
                    ...
                    using (new EditorGUIHelper.GUIBackgroundColor(EditorUtilities.ContainsInvalidFileNameCharacters(meshFileSuffix) ? Color.red : Color.white))
                    {
        ...
        bool IsMeshGeneratorReady()
        {
            if ((meshBatchObjects == null || meshBatchObjects.Count == 0) ||
               ...
               (meshSaveLocation == SAVE_LOCATION.SameAsSourceAssetButInSubfolder && EditorUtilities.ContainsInvalidFileNameCharacters(meshSubfolderName)) ||
