...
namespace VolumetricFogAndMist {
    ...
    public class VolumetricFogInspector : Editor {
        ...
        SerializedProperty _lightScatteringEnabled, _lightScatteringDiffusion, _lightScatteringExposure, _lightScatteringSpread, _lightScatteringWeight, _lightScatteringIllumination, _lightScatteringDecay, _lightScatteringSamples, _lightScatteringTint, _lightScatteringJittering, _lightScatteringBlurDownscale;
        ...
        SerializedProperty _downsampling, _forceComposition, _blurComposition, _blurEdgeThreshold, _edgeImprove, _edgeThreshold, _stepping, _steppingNear, _dithering, _ditherStrength, _jitterStrength, _spsrBehaviour, _useSinglePassStereoRenderingMatrix, _updateTextureSpread, _timeBetweenTextureUpdates;
