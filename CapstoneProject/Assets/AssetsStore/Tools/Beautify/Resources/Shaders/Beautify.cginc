	...
	void beautifyPass(v2f i, inout float3 rgbM) {
        ...
        if (dDepth > ANTIALIAS_THRESHOLD) {
            ...
            float3 rgbA = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_MainTex, i.uv + n * (1.0 / 3.0 - 0.5)).rgb + UNITY_SAMPLE_SCREENSPACE_TEXTURE(_MainTex, i.uv + n * (2.0 / 3.0 - 0.5)).rgb;
            float3 rgbB = 0.25 * (rgbA + UNITY_SAMPLE_SCREENSPACE_TEXTURE(_MainTex, i.uv + n * (0.0 / 3.0 - 0.5)).rgb + UNITY_SAMPLE_SCREENSPACE_TEXTURE(_MainTex, i.uv + n * (3.0 / 3.0 - 0.5)).rgb);
