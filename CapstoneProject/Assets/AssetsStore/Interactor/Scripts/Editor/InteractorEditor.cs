...
namespace razz
{
    ...
    public class InteractorEditor : Editor
    {
        ...
        private void AdjustCollider(Animator animator)
        {
            ...
            if (head && foot)
            {
                ...
                if (!check || !check2)
                {
                    ...
                    Debug.Log("Sphere Collider adjusted to body center and size.", _script);
                }
            }
        }
        ...
        private void RestartScene()
        {
            ...
            if (currentScene == exampleScene1 || currentScene == exampleScene2 || currentScene == exampleScene3 || currentScene == exampleScene4)
            {
