...
namespace razz
{
    public class @InteractorKeys : IInputActionCollection, IDisposable
    {
    ...
    ""controlSchemes"": []
        ...
        private IInteractorExampleSceneControlsActions m_InteractorExampleSceneControlsActionsCallbackInterface;
        ...
        public struct InteractorExampleSceneControlsActions
        {
            ...
            {
                if (m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface != null)
                {
                    @MouseWheel.started -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnMouseWheel;
                    @MouseWheel.performed -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnMouseWheel;
                    @MouseWheel.canceled -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnMouseWheel;
                    @Move.started -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnMove;
                    @Move.performed -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnMove;
                    @Move.canceled -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnMove;
                    @Brake.started -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnBrake;
                    @Brake.performed -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnBrake;
                    @Brake.canceled -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnBrake;
                    @Vertical.started -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnVertical;
                    @Vertical.performed -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnVertical;
                    @Vertical.canceled -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnVertical;
                    @Horizontal.started -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnHorizontal;
                    @Horizontal.performed -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnHorizontal;
                    @Horizontal.canceled -= m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface.OnHorizontal;
                }
                m_Wrapper.m_InteractorExampleSceneControlsActionsCallbackInterface = instance;
                if (instance != null)
                {
