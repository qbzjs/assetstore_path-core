    ...
    void Tab_Setup()
    {
        ...
        if (showEyes)
        {
            ...
            for (int i = 0; i < Get.Eyes.Count; i++)
            {
                ...
                if (eyeSetup != null && eyeSetup.ControlType == FIMSpace.FEyes.FEyesAnimator.EyeSetup.EEyeControlType.Blendhsape)
                {
                ...
                if (eyeSetup != null && eyeSetup.ControlType == FIMSpace.FEyes.FEyesAnimator.EyeSetup.EEyeControlType.Blendhsape && eyeSetup._BlendFoldout)
                {
                    ...
                    if (eyeSetup.BlendshapeMesh == null)
                    {
                        EditorGUILayout.HelpBox("Could not detect blendhsape mesh! Change eye object to be transform of blendhsape mesh!", MessageType.None);
