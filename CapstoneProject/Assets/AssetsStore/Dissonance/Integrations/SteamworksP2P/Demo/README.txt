Dissonance Steamworks.NET Demo
==============================

This demo demonstrates the core features of Dissonance voice comms with Steamworks.NET P2P networking:

* The Dissonance Steamworks.NET "DissonanceSetup" prefab.
...
1. Add both "SteamworksDotnetDemo" and "SteamworksDotnetGameWorld" scenes to your project's build settings, and drag "SteamworksDotnetDemo" to the top of the list.
3. Click File -> Build and Run.
4. Once the client is running, run the Demo scene in the editor.
5. In editor, click "Create Game".
6. On the client, click the button labelled with the ID of the session you just created.
