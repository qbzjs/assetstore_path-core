Dissonance Steamworks.NET Integration
=====================================

This package integrates Dissonance Voice Chat (https://assetstore.unity.com/packages/tools/audio/dissonance-voice-chat-70078?aid=1100lJDF) with the Steamworks.NET (https://steamworks.github.io/) for peer to peer session. To use this package you must have purchased and installed Dissonance and Steamworks.NET - **you will encounter build errors until you have done this**!

The included demo scene (Assets/Dissonance/Integrations/SteamworksP2P/Demo/SteamworksDotnetDemo) demonstrates the basics of a voice chat session running in a Steam p2p session. Consult the readme file in the demo folder for details on how to run the demo and what features it demonstrates.
