        ...
        private void HandleLobbyEnterSuccess(LobbyEnter_t arg0)
        {
            ...
            if (nLobby.IsGroup)
            {
                ...
                API.Matchmaking.Client.JoinLobby(nLobby, (lobbyenter, sucess) =>
                {
                    ...
                    {
                        Debug.Log("this is the lobbyenter stuff " + lobbyenter);
                        Debug.Log("This is the nlobby stuff: " + nLobby);
                        Debug.Log("This is therresult  stuff: " + lobbyenter.data.m_EChatRoomEnterResponse);
                    }
                });
            }
        }
