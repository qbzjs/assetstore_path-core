...
namespace razz
{
    ...
    public class BasicInput : MonoBehaviour
    {
        ...
        public static float GetBrake()
        {
            ...
            return keys.InteractorExampleSceneControls.Brake.ReadValue<float>();
        }
        ...
        private void Update()
        {
            ...
            if (!use)
            {
                ...
                if (use && (_interactionStates.playerChangable || _interactionStates.playerClimable))
                {
                    ...
                    else if(_interactor.selectedByUI < _interactor.intOjbComponents.Count && _interactor.intOjbComponents[_interactor.selectedByUI].interactorObject.interactionType == InteractionTypes.MultipleCockpit)
                    {
                        changed = true;
                        use = false;
                    }
