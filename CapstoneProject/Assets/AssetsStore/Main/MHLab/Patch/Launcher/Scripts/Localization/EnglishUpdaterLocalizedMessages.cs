...
namespace MHLab.Patch.Launcher.Scripts.Localization
{
    public sealed class EnglishUpdaterLocalizedMessages : IUpdaterLocalizedMessages
    {
        ...
        public string CheckingForNetworkAvailability => "Checking for network connectivity...";

        public string NotAvailableNetwork =>
            "Network is not available or connectivity is low/weak... Check your connection!";

        public string CheckingForServerAvailability => "Trying to contact the remote server...";
        ...
        public string UpdateUnableToStartTargetApplication =>
            "Updating process completed, but unable to start the target application!";

        public string CollectingIndexMetadata        => "Collecting metadata from the remote server...";
        public string CollectingCurrentBuildInfo     => "Collecting current version info...";
        public string CalculatingPatchesShortestPath => "Calculating the shortest update path...";
    }
}