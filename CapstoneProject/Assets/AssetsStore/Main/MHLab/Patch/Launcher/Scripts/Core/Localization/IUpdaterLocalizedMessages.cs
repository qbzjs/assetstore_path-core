namespace MHLab.Patch.Core.Client.Localization
{
    public interface IUpdaterLocalizedMessages
    {
        ...
        string CheckingForNetworkAvailability { get; }
        string NotAvailableNetwork            { get; }
        string CheckingForServerAvailability  { get; }
        ...
        string UpdateUnableToStartTargetApplication { get; }

        string CollectingIndexMetadata        { get; }
        string CollectingCurrentBuildInfo     { get; }
        string CalculatingPatchesShortestPath { get; }
    }
}