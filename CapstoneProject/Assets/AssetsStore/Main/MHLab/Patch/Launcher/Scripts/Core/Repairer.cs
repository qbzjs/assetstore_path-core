...
namespace MHLab.Patch.Core.Client
{
    public class Repairer : IUpdater
    {
        ...
        {            
            ...
            _context.RunDiskSpaceCheck(sizeToRepair);
        ...
        private void SetDefinition(FilePath filePath, BuildDefinitionEntry entry)
        {
            try
            {
            ...
            {
                _context.Logger.Error(e , $"Cannot set file attributes on [{entry.RelativePath}]: this could lead to unwanted behaviors...");
            }
            ...
            {
                _context.Logger.Error(e , $"Cannot set LastWriteTime [{entry.LastWriting}] on [{entry.RelativePath}]: this could lead to unwanted behaviors...");
            }
        }
