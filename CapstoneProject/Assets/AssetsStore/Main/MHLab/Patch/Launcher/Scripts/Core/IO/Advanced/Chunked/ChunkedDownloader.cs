                ...
                if (sharedContext.ChunkStorage.FetchNext(out var chunkInfo))
                {
                    ...
                    try
                    {
                        ...
                        if (downloadedSize < 0)
                        {
                            ...
                            // Enqueue this chunk again, since it didn't get stored on disk.
                            sharedContext.ChunkStorage.EnqueueDownloadableChunk(chunkInfo.Chunk);
                            continue;
                        }
                    ...
                    {
                        _context.Logger.Error(e, "ChunkedDownloader raised an error during the main loop:");
                    }
                }
            }
