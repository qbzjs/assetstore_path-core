...
namespace Opsive.UltimateInventorySystem.Editor.Managers
{
    ...
    public class ItemDefinitionManager : InventorySystemObjectBaseManager<ItemDefinition>
    {
        ...
        /// <summary>
        /// The item definition was renamed, therefore the item should be renamed.
        /// </summary>
        /// <param name="itemDefinition">The item definition that changed names.</param>
        /// <param name="previousName">The previous item name.</param>
        /// <param name="newName">The new item definition name.</param>
        public override void ObjectWasRenamed(ItemDefinition itemDefinition, string previousName, string newName)
        {
            itemDefinition.DefaultItem.name = newName;
        }
