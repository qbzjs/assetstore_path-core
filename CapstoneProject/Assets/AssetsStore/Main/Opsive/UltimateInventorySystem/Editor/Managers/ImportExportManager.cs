namespace Opsive.UltimateInventorySystem.Editor.Managers
{
    ...
    public class ImportExportManager : InventoryManager
    {
        ...
        protected NestedInspectedObjectField<ImportExportModule,SimpleObjectInspector> m_ImportExportModuleField;
        ...
        public override void BuildVisualElements()
        {
            ...
            m_ImportExportModuleField = new NestedInspectedObjectField<ImportExportModule, SimpleObjectInspector>(
