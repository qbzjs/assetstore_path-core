...
namespace Opsive.UltimateInventorySystem.UI.Panels.ActionPanels
{
    ...
    {
        public event Action OnActionsAssigned;
        ...
        [Tooltip("Event when the actions are assigned.")]
        [SerializeField] protected UnityEvent m_OnActionsAssignedEvent;
        ...
        public virtual void AssignActions(IList<T> actions)
        {
            m_Actions = actions;
            OnActionsAssigned?.Invoke();
            m_OnActionsAssignedEvent?.Invoke();
        }
        ...
        protected virtual ActionButton AddButtonAtIndex(int i)
        {
