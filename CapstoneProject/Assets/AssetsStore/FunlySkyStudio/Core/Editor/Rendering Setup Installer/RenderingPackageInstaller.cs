...
namespace Funly.SkyStudio {
    ...
    /// </summary>
    public abstract class RenderingPackageInstaller
    {
        ...
        public static void Install(RenderingConfig.DetectedRenderingConfig renderingConfig) {
        ...
        public static void InstallPackage(string packageName) {
            ClearInstalledVersionFile();

            string rootDir = SkyEditorUtility.SkyStudioRootDirectory();
            string packagePath = $"{rootDir}/Core/Editor/Rendering Support Packages/{packageName}";

            AssetDatabase.ImportPackage(packagePath, false);
            UpdateInstalledVersionFile(packageName);
        }
        
        public static Boolean ShouldInstallContent(string packageName)
        {
        ...
        public static RenderingContentVersion GetInstalledVersionFile()
        {
